...
backgroundImg1.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/backgroundimage1.jpg`
backgroundImg2= new Image()
backgroundImg2.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/backgroundimage2.jpg`
backgroundImg3= new Image()
backgroundImg3.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/backgroundimage3.jpg`
backgroundImg4= new Image()
backgroundImg4.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/backgroundimage4.jpg`
backgroundImg5= new Image()
backgroundImg5.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/backgroundimage5.jpg`
backgroundImg6= new Image()
backgroundImg6.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/backgroundimage6.jpg`
...
startButtonImg.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/startbutton.png`
gameOverButtonImg = new Image()
gameOverButtonImg.src = 'https://github.com/HadrienMv/obelix-game/blob/main/resources/gameover.png'
gameOverButtonImg.id = `game-over-img`
replayButtonImg = new Image()
replayButtonImg.src = 'https://github.com/HadrienMv/obelix-game/blob/main/resources/replay.png'
replayButtonImg.id = 'replay-button'
replayButtonImg.addEventListener('click',()=>{
    location.reload()
}, {once : true})

themeAudio = new Audio('https://github.com/HadrienMv/obelix-game/blob/main/resources/themeobelix.mp3')
themeAudio.loop = true
themeAudio.volume = 0.15
playAudio = new Audio('https://github.com/HadrienMv/obelix-game/blob/main/resources/gameobelix.mp3')
playAudio.loop = true
playAudio.volume = 0.15

killAudio1 = new Audio('https://github.com/HadrienMv/obelix-game/blob/main/resources/audiofrappe1.mp3')
killAudio2 = new Audio('https://github.com/HadrienMv/obelix-game/blob/main/resources/audiofrappe2.mp3')
killAudio3 = new Audio('https://github.com/HadrienMv/obelix-game/blob/main/resources/audiofrappe3.mp3')
killAudio4 = new Audio('https://github.com/HadrienMv/obelix-game/blob/main/resources/audiofrappe4.mp3')
let killAudios = [killAudio1, killAudio2, killAudio3, killAudio4]

gameOverAudio = new Audio('https://github.com/HadrienMv/obelix-game/blob/main/resources/audiogameover.mp3')
reloadAudio = new Audio('https://github.com/HadrienMv/obelix-game/blob/main/resources/gunreload.mp3')
jumpAudio = new Audio('https://github.com/HadrienMv/obelix-game/blob/main/resources/jump.mp3')
...
// Creating the player
playerImg = new Image()
playerImg.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/obelix-nav.png`
...
boulderImg.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/boulderimg.png`
...
romanOneImg.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/Romain1.png`
romanTwoImg = new Image()
romanTwoImg.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/Romain2.png`
romanThreeImg = new Image()
romanThreeImg.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/Romain3.png`
romanFourImg = new Image()
romanFourImg.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/Romain4.png`
romanFiveImg = new Image()
romanFiveImg.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/Romain5.png`
romanDeadImg = new Image()
romanDeadImg.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/romaindead.png`
...
miniBoulderImg.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/miniboulder.png`
...
miniBoulderInventoryImg.src = `https://github.com/HadrienMv/obelix-game/blob/main/resources/boulderinventory.png`
